...
const add_button = () => (
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 42 42">
        <path
...
export default { add_button, back_button, edit_button, delete_button, save_button }
